...
function findIndexWithSameValues(array, obj, keysToIgnore = []) {
    // console.log('b2bCheckoutShippingAddressUtils findIndexWithSameValues');
    for (let i = 0; i < array.length; i++) {
        const currentObj = array[i];
        if (Object.keys(obj).every(key => {
            // console.log('b2bCheckoutShippingAddressUtils i: '+i+', key: '+key+', obj[key]: '+obj[key]+', currentObj[key]: '+currentObj[key]);
            return  (
